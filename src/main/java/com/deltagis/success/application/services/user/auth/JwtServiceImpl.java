...
import com.deltagis.success.domain.ports.user.auth.IJwtService;
...
public class JwtServiceImpl implements IJwtService {
    private final byte[] privateKey = ".AB1o&tb`nFt-IplooR[L/l0D0>cLFf$;W>NI+[md-C{Z*~pA25A#qL]x2+GCJ&2Bk_7".getBytes();
